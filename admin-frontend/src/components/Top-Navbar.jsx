              ...
              <div className="flex items-center justify-between py-3 xl:px-6 sm:px-2 p-2">
                ...
                <div className="flex items-center space-x-3 ">
                  ...
                  <div className="flex flex-col">
                    {user && user._id ? (
                      <>
                        <p className="font-medium dark:text-zinc-200 text-gray-800">{user.full_name}</p>
                      </>
                    ) : (
                      <Link to="/login">
                        <button className="font-medium text-white bg-black   px-4 py-2 rounded-full">Signin</button>
                      </Link>
                    )}
                  </div>
                </div>
