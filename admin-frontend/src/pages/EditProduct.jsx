...
const EditProduct = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/admin/product/update`, formData,);
  ...
  return (
    <div className="fixed top-0 right-0 overflow-y-auto xl:w-[80%] sm:w-full h-full py-12 px-4 sm:px-6 lg:px-8 z-20">

      <div className="w-full xl:p-10 py-10">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="px-6 py-8 sm:p-10">
            ...
            <div className="text-center mb-10">
              ...
              <p className="mt-2 text-sm text-gray-600">Fill in the details below to edit product to the menu</p>
            </div>
                      ...
                      {image ? (
                        <>
                          <div className="w-full h-full overflow-hidden flex items-center justify-center">
                            <img
                              src={image}
                              className="w-[80%] xl:h-[400px] sm:h-[200px] rounded-xl object-cover"
                            />
                          </div>
                        </>
                      ) : (
